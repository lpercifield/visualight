...
//  wifly.sendChunkln(F("<p>Visualight Setup</p>"));
//  wifly.sendChunkln(F("</h1>"));
...
//    wifly.sendChunkln(F("<select name=\"MODE\">"));
//    wifly.sendChunkln(F("<option selected=\"selected\" value=\"WPA_MODE\">WPA Mode</option>"));
//    wifly.sendChunkln(F("<option value=\"WEP_MODE\">WEP Mode</option>"));
//    wifly.sendChunkln(F("</select>"));
//    wifly.sendChunkln(F("<input type=\"hidden\" name=\"SKEY\" value=\"bitponicsSecretspitbonicsstecres\"/>");
//    wifly.sendChunkln(F("<input type=\"hidden\" name=\"PKEY\" value=\"pitbonicspublics\"/>");
    wifly.sendChunkln(F("<input type=\"submit\" value=\"Submit\" />"));
